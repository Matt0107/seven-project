...
router.post("/booking", (req, res, next) => {
  const { name, email, phone, pickupOption, pickupDate, returnDate, car } =
    req.body;
...
let a = new Car({
  ...
  image:
    "https://imgd.aeplcdn.com/1056x594/n/cw/ec/48067/s-class-exterior-right-front-three-quarter-3.jpeg?q=75&wm=1",
});
let b = new Car({
  brand: "BMW",
  model: "7 Series",
  ...
  transmission: "Automatic ",
  image:
    "https://mediapool.bmwgroup.com/cache/P9/202204/P90458181/P90458181-the-new-bmw-i7-xdrive60-04-2022-600px.jpg  ",
});
let c = new Car({
  brand: "Audi ",
  model: "A8  ",
  ...
  transmission: "Automatic  ",
  image:
    "https://mediaservice.audi.com/media/live/50900/fly1400x601n1/4nc0da/2022.png?imwidth=850",
});
let d = new Car({
  brand: "Rolls-Royce",
  model: "Ghost",
  ...
  transmission: "Automatic",
  image:
    "https://autoartmodels.de/wp-content/uploads/2020/04/78868w-scaled.jpg  ",
});
let e = new Car({
  brand: "Lexus",
  model: "LS",
...
let f = new Car({
  ...
  transmission: "Automatic",
  image:
    "https://www.nicepng.com/png/detail/66-663928_2018-rolls-royce-phantom-rolls-royce-ghost-2018.png  ",
});
a.save();
b.save();
c.save();
